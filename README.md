...
💡 주요 기술적 챌린지
<br/>
1️⃣ Scale-out 환경에서 WebSocket 세션 공유 문제
🔴 문제 상황
...
TCP 연결 상태 점검
Heartbeat 모니터링
근본 원인 파악: Spring Boot 메모리 기반 세션 관리의 한계
...
<br/>
8️⃣ Google OAuth 불완전 정보 처리
🔴 문제
Google OAuth로 전달받는 정보가 회원가입 필수 정보 미달
✅ 해결

첫 로그인 시 사용자 정보를 Redis에 임시 캐싱
프론트엔드에서 추가 정보 입력 폼 제공
정보 완성 후 정상 회원가입 프로세스 진행
